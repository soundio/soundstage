...
A buffer object is a wrapper for the standard AudioBufferSourceNode, but where
that node may only be started once, a buffer object may be started and stopped
at will.
*/
