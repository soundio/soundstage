...
docs:
	deno run --allow-read --allow-env --allow-net --allow-write --allow-run --unstable ../literal/deno/make-comments.js ./modules/ ./docs/ ../literal/docs/includes/page.literal debug
