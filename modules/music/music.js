...
(function(window) {
	...
	var gcd         = Fn.gcd;
	var lcm         = Fn.lcm;
	var factorise   = Fn.factorise;
	var root        = Math.sqrt;
	var increment   = Fn.add(1);
	var decrement   = Fn.add(-1);
	var increment12 = Fn.add(12);
	var decrement12 = Fn.add(-12);
	var getArray    = Fn.get('array');
	var getTrans    = Fn.get('trans');
	var getLength   = Fn.get('length');
